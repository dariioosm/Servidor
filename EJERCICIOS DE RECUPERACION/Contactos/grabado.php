...
<body>
    ...
    <a href="index.php"><?php session_destroy(); ?>Volver a loguearse</a> <br>
    <a href="agenda.php">Agregar mas contactos para <?php unset($_SESSION['incrementos']); echo htmlspecialchars($_SESSION['usuario']);?></a><br>
