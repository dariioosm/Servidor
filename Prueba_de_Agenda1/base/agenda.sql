/* Como agregar la base, dentro de phpmyadmin le damos arriba a la izquierda a la casita 
  una vez hecho esto buscamos la opción importar y damos a buscar archivo y buscamos este archivo 
  y así ya habremos creado la base de datos */
