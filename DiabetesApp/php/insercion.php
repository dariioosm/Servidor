...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    //?Posibles datos de las tablas hiper e hipoglucemia (puede esta vacia la tabla)
    ...
    //TODO comprobacion de campos obligatorios
    if(empty($tipo_comida)||empty($tipo_comida)||empty($raciones)||empty($glucosa_pre)||empty($insulina)||empty($glucosa_pos)){
        echo 'Campos obligatorios sin rellenar';
    }else{
        //TODO insercion en tabla comida
        ...
        if($insert_comida->execute()){
            ...
            echo'Error al insertar datos en la tabla'. $insert_comida->error;
        }
        ...
        //TODO inertar en tabla hipoglucemia
